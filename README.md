...
## Features:
- County priority ranking 
-  Urgency-level filtering
-  County detail views
-  Food need and health risk based prioritization 
- Support, sponsorship, and partnership pathways 
...
- Streamlit
## Project Purpose :
Carelio was created to support planning and outreach by helping identify Minnesota counties where food support may need more attention. The goal is to turn data into a practical decision-support tool that can be explored more easily by community-focused users. 
## Future Improvements:
This project can be extended further by incorporating regularly updated data, additional community indicators, and more interactive features to support planning and outreach. 
## Created By Sruthi Vemavarapu
